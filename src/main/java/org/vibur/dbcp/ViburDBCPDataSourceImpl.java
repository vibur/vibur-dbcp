 ...
 */
public class ViburDBCPDataSourceImpl extends ViburDBCPConfig
    implements ViburDBCPDataSource, DataSource, DestroyListener {

    private static final org.slf4j.Logger logger = LoggerFactory.getLogger(ViburDBCPDataSourceImpl.class);
     ...
     * setter methods.
     */
    public ViburDBCPDataSourceImpl() {
        initJMX();
    }
     ...
     */
    public ViburDBCPDataSourceImpl(String configFileName) {
        this();
        URL config;
     ...
     * @throws ViburDBCPException if cannot configure successfully
     */
    public ViburDBCPDataSourceImpl(Properties properties) {
        this();
