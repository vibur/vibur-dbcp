...
public abstract class ViburConfig {
     ...
     * {@link ViburListener#getTakenToString()}. */
     ...
     * will add to the log generated by {@link ViburListener#getTakenToString()} the current stack traces of
    ...
    public String getTakenConnectionsAsString() {
        ...
        return ((ViburListener) getPool().listener()).getTakenToString();
    }
