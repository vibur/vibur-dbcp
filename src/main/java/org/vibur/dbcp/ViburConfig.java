...
public abstract class ViburConfig {
     ...
     * {@link #getTakenConnectionsAsString()}. */
     ...
     * will add to the log generated by {@link ViburListener#getTakenConnectionsAsString()} the current stack traces of
     * all live threads in the JVM that are <b>not</b> holding connections. In other words, the combination of these
     * two options is equivalent to generating a full JVM thread dump, and thus it has to be used for troubleshooting
     * purposes only, as it may generate a VERY large log output. */
    ...
    /**
     * See the comments for {@link #logTakenConnectionsOnTimeout}. Also see {@link #getTakenConnections}.
     */
    public String getTakenConnectionsAsString() {
        ...
        return ((ViburListener) getPool().listener()).getTakenConnectionsAsString();
    }
     ...
     * after this method returns. Also see {@link #getTakenConnectionsAsString}.
     *
