 ...
 */
public class TakenConnectionsFormatter {

    private final ViburConfig config;

    public TakenConnectionsFormatter(ViburConfig config) {
        this.config = config;
    }
     ...
     *
     * <p>Also see {@link org.vibur.dbcp.ViburDataSource#getTakenConnectionsStackTraces()}.
     */
