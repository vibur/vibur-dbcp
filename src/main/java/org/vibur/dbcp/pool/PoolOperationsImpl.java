 ...
 */
public class PoolOperationsImpl implements PoolOperations {

    private static final Logger logger = LoggerFactory.getLogger(PoolOperationsImpl.class);
    ...
    /**
     * Instantiates this PoolOperationsImpl facade.
     *
     ...
     */
    public PoolOperationsImpl(ViburObjectFactory connectionFactory, PoolService<ConnHolder> poolService, ViburConfig config) {
        this.config = config;
    ...
    private Connection doGetProxyConnection(long timeout) throws SQLException, ViburDBCPException {
        ...
        if (conn != null) {
            ...
            return newProxyConnection(conn, config);
        }
